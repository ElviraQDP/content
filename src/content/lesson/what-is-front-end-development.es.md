...
Al usar todo tu conocimiento algorítmico (bucles, condicionales, etc.), ahora puedes permitir que el computador genere código HTML basado en diferentes tipos de eventos (interacciones del usuario o eventos del sistema) que ocurren durante la vida de cualquier sitio web.
...
+ Podrás crear juegos como: gato, colgado, etc.
+ ¡El cielo es el límite!  Los desarrolladores de Front-end pueden crear juegos, sitios web y aplicaciones para cualquier tipo de industria.
...
+ **Tiempo de Ejecución (Runtime)**: Esta es la línea de tiempo de tu sitio web desde el momento en que termina de cargarse hasta el momento en que el usuario sale de ella.
