...
También puede cambiar cualquier regla o propiedad CSS aplicada a los elementos HTML utilizando el atributo **.Style**, así:
...
Para mayor información sobre como acceder al DOM ver: https://developer.mozilla.org/en-US/docs/Web/API/Document
